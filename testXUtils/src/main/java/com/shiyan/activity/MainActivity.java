...
import com.shiyan.R;
import com.shiyan.bean.PersonInfoBean;
import com.shiyan.inteface.MyCallBack;
import com.shiyan.inteface.MyProgressCallBack;
import com.shiyan.util.XUtil;
...
public class MainActivity extends ActionBarActivity {
	...
	private void downloadfile() {
		//文件下载地址
		String url="http://zhbj007.sinaapp.com/hbkdzs/hbkdassistant2-release.apk";
		//文件保存在本地的路径
		...
		XUtil.DownLoadFile(url, filepath,new MyCallBack<File>(){
			...
			public void onSuccess(File result) {
				super.onSuccess(result);
				Toast.makeText(MainActivity.this,"下载成功"+result.getPath(),Toast.LENGTH_SHORT).show();
			}
